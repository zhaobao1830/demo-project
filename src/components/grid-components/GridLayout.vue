...
<script>
  import Vue from 'vue'
  import { bottom, compact, getLayoutItem, moveElement, validateLayout, cloneLayout, getAllCollisions } from '@/core/grid/helpers/utils'
  import { getBreakpointFromWidth, getColsFromBreakpoint, findOrGenerateResponsiveLayout } from '@/core/grid/helpers/responsiveUtils'
  import { addWindowEventListener, removeWindowEventListener } from '@/core/grid/helpers/DOM'
  ...
  export default {
    ...
    methods: {
      ...
      containerHeight: function () {
        ...
        return bottom(this.layout) * (this.rowHeight) + 'px'
      },
